...
def get_hyperparams():
    ...
    parser.add_argument('--dataset', type=str, default='mix', choices=['har', 'geo', 'sleep', 'mix', 'esr', 'ad', 'dev', 'whale', 'ecg'])
    ...
    parser.add_argument("--adapt", action="store_true", help="Finetune on a pretrained model (default: False).")

    parser.add_argument("--num_beams", type=int, default=1, help="Number of generation beams.")
    parser.add_argument("--num_return_sequences", type=int, default=1)
    parser.add_argument("--data_root", type=str, default="./datasets", help="dataset root directory")
    parser.add_argument("--vqvae_root", type=str, default="./vqvae", help="vqvae/tokenizer root directory")
